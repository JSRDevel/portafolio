...
const ProjectCard = ({ title, desc, img, type, id }) => {
        ...
        <div className="group bg-surface-container-low border border-outline-variant/10 overflow-hidden rounded-lg">
            ...
            <div className="p-8">
                <div className="flex flex-wrap gap-4 mb-6">
                    ...
                    <span className="bg-surface-container-highest text-white font-label text-[9px] px-3 py-1 uppercase tracking-widest rounded-lg">STATUS: STABLE</span>
                </div>
